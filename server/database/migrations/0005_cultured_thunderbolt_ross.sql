...
CREATE TABLE `__new_coupons` (
	...
	`created_at` integer DEFAULT '"2025-01-26T17:49:09.725Z"' NOT NULL,
...
CREATE TABLE `__new_order_items` (
	...
	`price` integer NOT NULL,
	`created_at` integer DEFAULT '"2025-01-26T17:49:09.726Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`password` text,
	`avatar` text,
	`created_at` integer DEFAULT '"2025-01-26T17:49:09.724Z"' NOT NULL
);
--> statement-breakpoint
